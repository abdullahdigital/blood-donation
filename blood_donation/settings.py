...
SECRET_KEY = 'django-insecure-ob^u%%l+kyd=dy!v8@9(6u%cy-wpu1@s()l7)9dd8ami41#9i-'
...
AUTHENTICATION_BACKENDS = [
    ...
    'donation.backends.EmailAuthBackend',  # Replace with your actual app and backend name
]
